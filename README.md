...
| *[Splunk Installation & Configuration](https://github.com/ashik0x/Splunk-Siem-lab)*    | Step-by-step implementation of a Splunk SIEM lab including installation, configuration, log forwarding, and security event monitoring. | 
